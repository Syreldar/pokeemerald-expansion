...
static const u32 sMugshotImg_Porygon[] = INCBIN_U32("graphics/mugshots/porygon.4bpp.lz");
static const u16 sMugshotPal_Porygon[] = INCBIN_U16("graphics/mugshots/porygon.gbapal");
...
static const struct Mugshot sMugshots[] = {
    [MUGSHOT_PORYGON] = {
        ...
        .width = 64,
        .height = 64,
        .image = sMugshotImg_Porygon,
        .palette = sMugshotPal_Porygon
    },
};
