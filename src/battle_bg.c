...
bool8 LoadChosenBattleElement(u8 caseId)
{
    ...
    case 4:
        ...
        break;
    case 5:
        LoadCompressedPalette(sBattleTerrainTable[GetBattleTerrainOverride()].palette, BG_PLTT_ID(2), 3 * PLTT_SIZE_4BPP);
        break;
    case 6:
        LoadBattleMenuWindowGfx();
        break;
