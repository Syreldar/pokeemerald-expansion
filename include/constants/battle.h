...
#define BATTLE_TERRAIN_SECRET_POWER_END BATTLE_TERRAIN_ULTRA_SPACE

// New battle terrains for the improved loading system
#define BATTLE_TERRAIN_FRONTIER         (BATTLE_TERRAIN_SECRET_POWER_END + 1)
#define BATTLE_TERRAIN_GYM              (BATTLE_TERRAIN_SECRET_POWER_END + 2)
#define BATTLE_TERRAIN_LEADER           (BATTLE_TERRAIN_SECRET_POWER_END + 3)
#define BATTLE_TERRAIN_MAGMA            (BATTLE_TERRAIN_SECRET_POWER_END + 4)
#define BATTLE_TERRAIN_AQUA             (BATTLE_TERRAIN_SECRET_POWER_END + 5)
#define BATTLE_TERRAIN_SIDNEY           (BATTLE_TERRAIN_SECRET_POWER_END + 6)
#define BATTLE_TERRAIN_PHOEBE           (BATTLE_TERRAIN_SECRET_POWER_END + 7)
#define BATTLE_TERRAIN_GLACIA           (BATTLE_TERRAIN_SECRET_POWER_END + 8)
#define BATTLE_TERRAIN_DRAKE            (BATTLE_TERRAIN_SECRET_POWER_END + 9)
#define BATTLE_TERRAIN_CHAMPION         (BATTLE_TERRAIN_SECRET_POWER_END + 10)
#define BATTLE_TERRAIN_GROUDON          (BATTLE_TERRAIN_SECRET_POWER_END + 11)
#define BATTLE_TERRAIN_KYOGRE           (BATTLE_TERRAIN_SECRET_POWER_END + 12)
#define BATTLE_TERRAIN_RAYQUAZA         (BATTLE_TERRAIN_SECRET_POWER_END + 13)

#define BATTLE_TERRAIN_CUSTOM_END       BATTLE_TERRAIN_RAYQUAZA
#define BATTLE_TERRAIN_COUNT            (BATTLE_TERRAIN_SECRET_POWER_END + BATTLE_TERRAIN_CUSTOM_END + 1)
...
#define B_WIN_MOVE_X4_EFFECTIVENESS   25
#define B_WIN_MOVE_X0_5_EFFECTIVENESS 26
#define B_WIN_MOVE_NO_EFFECT     27
